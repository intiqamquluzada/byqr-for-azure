...
from rest_framework.generics import ListAPIView, RetrieveUpdateDestroyAPIView, ListCreateAPIView, RetrieveAPIView, UpdateAPIView, DestroyAPIView, CreateAPIView
...
class DistanceView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        distance = self.get_distance(user.latitude, user.longitude, serializer.validated_data['latitude'], serializer.validated_data['longitude'])
