...
def get_card_reg_data_and_signature(language, refund, description, success_redirect_url='https://menu.byqr.az/az/tips-success', error_redirect_url='https://menu.byqr.az/az/tips-error'):
    json_string = json.dumps({
        "public_key": public_key,
        "language": language,
        "refund": refund,
...
def get_pay_and_save_data_and_signature(amount, currency, description, language, order_id, success_redirect_url, error_redirect_url):
    json_string = json.dumps({
        "public_key": public_key, 
        "amount": amount, 
        "currency": currency, 
