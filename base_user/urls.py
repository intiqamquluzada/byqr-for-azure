...
urlpatterns=[
    ...
    path("waiter/notification-token/update/", WaiterNotificationTokenUpdateView.as_view(), name='waiter_notification_token'),
    ...
    path("hotel-restaurant-admin/waiter/register/<str:restaurant_username>", HotelWaiterRegisterAdminView.as_view(), name='hotel_waiter_register'),
    path("hotel-restaurant-admin/waiter/list/<str:restaurant_username>", HotelWaiterListAdminView.as_view(), name='hotel_waiter_list'),
    path('hotel-restaurant-admin/waiter/update/<str:waiter_slug>', WaiterUpdateView.as_view(), name='waiter_update'),
    path('hotel-restaurant-admin/waiter/password/update/<str:waiter_slug>', WaiterPasswordUpdateView.as_view(), name='waiter_password_update'),
    ...
    path('restaurant-admin-campaign/retrieve/<str:campaign_id>', RestaurantCampaignRetrieveView.as_view(), name='restaurant_campaign_retrieve'),
    ...
    path('restaurant-admin-campaign/update/<str:campaign_id>', RestaurantCampaignUpdateView.as_view(), name='restaurant_campaign_update'),
    path('restaurant-categories/', RestaurantCategoryList.as_view(), name='restaurant-categories'),
    path('restaurant-sub-categories/', RestaurantSubCategoryList.as_view(), name='restaurant-sub-categories'),
    ...
    path('restaurant-story/list/<str:restaurant_slug>', RestaurantStoryListView.as_view(), name='restaurant-story-list'),
