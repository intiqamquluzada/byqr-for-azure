...
class RestaurantListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        loyalty_discount_percent = self.kwargs.get('loyalty_discount_percent')
...
from rest_framework.parsers import MultiPartParser, FormParser
from rest_framework import status
from .models import EventImages, RestaurantEvent, EventGenres, EventTypes
from .serializers import RestaurantEventSerializer
