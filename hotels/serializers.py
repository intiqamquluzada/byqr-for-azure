...
from .models import TechnicalService, Service, Question, FeedbackDescription, Feedback, HotelRoom
...
class FeedbackDescriptionStatisticSerializer(serializers.ModelSerializer):
    ...
    def get_weekly_feedbacks(self, obj):
        ...
        return FeedbackDescription.objects.filter(created_at__date__range=[week_start, week_end], room__hotel=hotel).count()
    ...
    def get_monthly_feedbacks(self, obj):
        ...
        return FeedbackDescription.objects.filter(created_at__date__range=[month_start, month_end], room__hotel=hotel).count()
